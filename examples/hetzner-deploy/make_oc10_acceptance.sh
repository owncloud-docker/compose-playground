...
source ./make_machine.sh -u acceptance-$d_vers -p git,screen,docker.io,composer,make,libxml2-utils,apache2,libapache2-mod-php,openssl,php-imagick,php-common,php-curl,php-gd,php-imap,php-intl,php-json,php-mbstring,php-mysql,php-ssh2,php-xml,php-zip,php-apcu,php-ldap,wget
